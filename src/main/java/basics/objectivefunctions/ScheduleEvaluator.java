...
public class ScheduleEvaluator implements ObjectiveFunction {

    Environment environment;

    public ScheduleEvaluator(Environment environment) {
    ...
    public double evaluate(int[] code) {
        ...
        System.arraycopy(code, 0, tspCode, 1, code.length);
