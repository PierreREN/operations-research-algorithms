...
import geneticalgorithm.population.TemplateIntegerPopulation;
 ...
 * @author Pierre REN
 */
public class IntegerSolver extends TemplateIntegerPopulation {
    ...
    static final int Nmin = 0;
    static final int Nmax = 5;

    public IntegerSolver() {
        super(NP);
        for (int k = 0; k < NP; k++) {
            population.add(new IntegerChromosome(geneLength, Nmin, Nmax));
        }
        setProblemNature();
